...
public class DialogoGenerarReportes extends JDialog implements ActionListener, ItemListener {
	...
	void reporteVentaOptima() {
		...
		if (unidVendidas0 < cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas0 + "(" + (cantOptima - unidVendidas0) + " menos que la cantidad Óptima)" + "\n\n");
		
		else if(unidVendidas0 > cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas0 + "(" + (unidVendidas0 - cantOptima) + " más que la cantidad Óptima)" + "\n\n");
		
		else
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas0 + "(igual a la cantidad Óptima)" + "\n\n");
					
		//Modelo1
		txtS.append("Modelo : " + modelo1 + "\n");
		
		if (unidVendidas1 < cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas1 + "(" + (cantOptima - unidVendidas1) + " menos que la cantidad Óptima)" + "\n\n");
		
		else if(unidVendidas1 > cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas1 + "(" + (unidVendidas1 - cantOptima) + " más que la cantidad Óptima)" + "\n\n");
					
		else
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas1 + "(igual a la cantidad Óptima)" + "\n\n");
					
		//Modelo2
		txtS.append("Modelo : " + modelo2 + "\n");
		
		if (unidVendidas2 < cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas2 + "(" + (cantOptima - unidVendidas2) + " menos que la cantidad Óptima)" + "\n\n");
		
		else if(unidVendidas2 > cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas2 + "(" + (unidVendidas2 - cantOptima) + " más que la cantidad Óptima)" + "\n\n");
		
		else
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas2 + "(igual a la cantidad Óptima)" + "\n\n");
		
		//Modelo3
		txtS.append("Modelo : " + modelo3 + "\n");
		
		if (unidVendidas3 < cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas3 + "(" + (cantOptima - unidVendidas3) + " menos que la cantidad Óptima)" + "\n\n");
		
		else if(unidVendidas3 > cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas3 + "(" + (unidVendidas3 - cantOptima) + " más que la cantidad Óptima)" + "\n\n");
		
		else
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas3 + "(igual a la cantidad Óptima)" + "\n\n");
					
		//Modelo4
		txtS.append("Modelo : " + modelo4 + "\n");
		
		if (unidVendidas4 < cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas4 + "(" + (cantOptima - unidVendidas4) + " menos que la cantidad Óptima)" + "\n\n");
		
		else if(unidVendidas4 > cantOptima)
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas4 + "(" + (unidVendidas4 - cantOptima) + " más que la cantidad Óptima)" + "\n\n");
		
		else
			txtS.append("Cantidad de unidades vendidas : " + unidVendidas4 + "(igual a la cantidad Óptima)" + "\n\n");
	}
	
	//Reporte del precio promedio
	void reportePrecioPromedio() {
		//imprimir titulo del reporte generado
		txtS.setText("PRECIO EN RELACIÓN AL PRECIO PROMEDIO" + "\n\n");
		//Imprimiendo el listado por modelo
